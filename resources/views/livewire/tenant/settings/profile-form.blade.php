<section id="profile-details-heading" aria-labelledby="profile-details-heading">
    <form wire:submit="submit">
        <div class="px-6">
            <div>
                <h2 id="profile-details-heading" class="text-lg font-medium leading-6">
                    Profile details
                </h2>
                <p class="mt-1 text-sm">
                    Update your profile information. Please note that anyone in your workspace will be able to see this information.
                </p>
            </div>
